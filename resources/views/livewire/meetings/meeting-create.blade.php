    ...
    <form wire:submit="save" class="w-full space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-1">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <div class="flex items-center gap-2">
                        <h1 class="text-xl sm:text-2xl font-bold tracking-tight text-slate-900 dark:text-white">Create Meeting</h1>
                    ...
                    <p class="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                        Session for <span class="font-semibold text-primary-600 dark:text-primary-400">{{ $currentClub->name }}</span>
                    </p>
                    @endif
                </div>
            </div>
            ...
            <div class="flex items-center gap-2.5 self-end sm:self-auto">
                <a href="{{ route('meetings.index') }}" class="px-4 py-2 text-xs sm:text-sm font-semibold text-slate-600 dark:text-slate-300 hover:bg-white dark:hover:bg-slate-800 rounded-2xl border border-slate-200/80 dark:border-slate-800 transition-colors">
                    Cancel
                </a>
        ...
        {{-- ================================================================ --}}
        {{-- STEP 1 CONTAINER: DETAILS & WORD OF THE DAY --}}
        {{-- ================================================================ --}}
        <div x-show="step === 1" x-cloak class="w-full space-y-6">
            ...
            <div class="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200/80 dark:border-slate-800 shadow-sm p-6 sm:p-8 transition-colors">
                <div class="flex items-center gap-3 mb-6 pb-3 border-b border-slate-100 dark:border-slate-800">
                    ...
                    <div>
                        <h2 class="text-base font-bold text-slate-900 dark:text-white">Meeting Information</h2>
                        <p class="text-xs text-slate-500 dark:text-slate-400">Date, number, theme, schedule and venue settings</p>
                    </div>
                </div>
