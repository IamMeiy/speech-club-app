<div class="p-6 lg:p-8">
    <div class="max-w-2xl mx-auto">
        <div class="flex items-center gap-4 mb-8">
            ...
            <h1 class="text-2xl font-bold text-gray-900">New Club</h1>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
            <form wire:submit="save" class="space-y-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1.5">Club Code <span class="text-red-500">*</span></label>
                        <input wire:model="code" type="text" placeholder="e.g. chola"
                               class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 @error('code') border-red-300 @enderror">
                ...
                <div>
                    ...
                    <input wire:model="location" type="text" placeholder="e.g. Conference Room A"
