<div class="p-6 lg:p-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                <h1 class="text-2xl font-bold text-slate-900 dark:text-white tracking-tight">Create Role</h1>
                <p class="text-slate-500 dark:text-slate-400 text-sm mt-0.5">Define a new system role and assign specific module permissions</p>
            </div>
        </div>
            ...
            <form wire:submit="save" class="space-y-6">
                ...
                <div class="pt-6 border-t border-slate-100 dark:border-slate-800">
                    <div class="flex items-center justify-between mb-4">
                        <div>
                            <label class="block text-sm font-bold text-slate-900 dark:text-white">Assign Permissions</label>
