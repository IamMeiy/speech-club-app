<div class="p-6 lg:p-8">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Edit Global User</h1>
                <p class="text-gray-500 text-sm mt-1">{{ $user->name }} ({{ $user->email }})</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
            <form wire:submit="save" class="space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1.5" for="global-phone">Phone</label>
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 mb-3">Select the clubs this global user can access and manage.</p>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1.5" for="global-password">New Password <span class="text-gray-400 font-normal">(leave blank to keep current)</span></label>
